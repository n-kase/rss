...
description: "概要と事実 オーストラリア政府は2025年12月10日から、国内で提供される特定のソーシャルメディアプラットフォームにおいて16歳未満の利用者がアカウントを持つことを禁止する新法を施行すると発表しました。この法律では、該当するアプリ開..."
date: 2026-06-16T10:49:36+09:00
categories: ["社会問題"]
tags: ["オーストラリア法", "ソーシャルメディア規制", "年齢確認API", "App Store対応", "未成年保護"]
...
### 概要と事実
オーストラリア政府は2025年12月10日から、国内で提供される特定のソーシャルメディアプラットフォームにおいて16歳未満の利用者がアカウントを持つことを禁止する新法を施行すると発表しました。この法律では、該当するアプリ開発者に対して既存の16歳未満アカウントの無効化および新規登録時の年齢確認を義務付けています。Appleはこの法令への対応を支援するため、いくつかの開発者向けツールを提供しています。まず、Declared Age Range APIというインターフェースにより、アプリは利用者が申告した年齢範囲（例：16歳未満）を取得し、それに応じて機能を制御できます。次に、App Storeでのアプリ説明文に年齢制限に関する補足情報を記載できるほか、App Store製品ページの年齢評価 questionnaire に新たに追加された「インアプリコントロール」の質問に答えることで、年齢確認や保護者向け管理機能の有無を示せます。さらに、年齢評価を手動で引き上げるオプションや、Age Suitability URL を設定して法令に関する詳細情報をリンクさせる方法も用意されています。

### ネットの反応と意見の変遷
この発表を受けて、開発者コミュニティでは対応コストとプライバシーへの懸念が同時に挙げられています。一部のデベロッパーは、年齢確認のために追加の個人情報収集が必要になることへの警戒感を示し、ユーザーの同意取得やデータ保護の負担が増えると指摘しています。一方、保護者団体や子どもの権利を専門とするNGOからは、未成年者を有害なコンテンツや過度な利用から守るための必要な措置だと歓迎する声が上がっています。SNS上では、法の施行日が近づくにつれて「実際に年齢偽装が防げるのか」という疑問や、回避策として偽の誕生日を入れるユーザーが増えるのではないかという予測が散見されます。また、Appleが提供するツールが開発者にとって実装しやすいかどうかという点についても議論が活発で、APIのドキュメントが十分か、他のプラットフォーム（Googleなど）にも同様の支援が求められるべきだという意見が見られます。

### 背景と結論
オーストラリアがこのような年齢制限法を導入した背景には、ソーシャルメディアが若者のメンタルヘルスに与える悪影響や、サイバーいじめ・不適切コンテンツへの暴露が社会問題化していることがあります。各国では同様の規制が検討される中、オーストラリアは先行して法整備を行い、プラットフォーム側に技術的対応を求める姿勢を示しました。今回Appleが提供したDeclared Age Range APIやApp Store内の年齢関連フィールドは、開発者が法令遵守のために必要な情報を取得しやすくすることを狙っており、業界全体のコンプライアンス負担を軽減する可能性があります。今後は、これらのツールが実際に未成年者のアカウント作成を効果的に防ぐか、プライバシー保護と年齢確認のバランスがどのように取られるかが注目されるでしょう。最終的に、技術的手段と法的枠組みが連携することで、若者が安全にデジタルサービスを利用できる環境づくりが進むことが期待されます。

[🔗 元記事を読む](https://developer.apple.com/news/?id=y1bckxf8)
