...
## AIによる要約
2019年から続く「Innovative Tech」連載で紹介されたジョージア工科大学などの研究チームによる論文では、栄養と食事の計画をテーマに、ChatGPTを使うグループと従来のGoogle検索を使うグループを8日間比較し、学習効果を測定した。その結果、ChatGPTグループは知識の応用や複数情報の比較評価において低い傾向が見られ、これはAIが完成された答えを優先し、原理や過程を飛ばしやすいこと、そして対話形式がユーザーの視野を狭めて情報の精査や別視点の探求を減らすためだと指摘されている。さらに、答えを得やすい反面、望む詳細度や形式に合わせるために質問の調整が必要となり、参加者はフラストレーションを感じていた。これらの点から、AIチャットボットは便利なツールだが、深い理解や批判的思考を育むためには、情報の裏付けや複数の情報源を自分で確認する習慣を保ち、AIはあくまで補助として使うべきだという教訓が得られる。
