...
## AIによる要約
ブラジル・リオデジャネイロ市の公営IT企業IplanRIOが独自開発と発表したAIモデル「Rio 3.5 Open 397B」について、既存のモデル「Nex‑N2‑Pro」と「Qwen3.5‑397B‑A17B」を約6対4の割合で混ぜただけではないかという指摘が出され、重みテンソルの比較でほぼ完全に一致することが判明した。これにより、公的機関がAIの開発過程を不透明に発表することへの懸念が高まり、ネット上ではモデルの真偽を検証する動きや、模倣や不正な主張への批判が広がっている。したがって、AIモデルの性能や開発経過については正確な情報開示と第三者による検証が不可欠であり、誤った主張は信頼を損なうだけでなく、技術の健全な発展を阻害するという教訓が得られる。
