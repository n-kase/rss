...
description: "2015年10月に発売されたiMacでは、従来のsRGBより広い色域を持つDCI-P3系の色空間（Apple P3）を採用し、広く知られているAdobe RGBではなくこの新しい色空間を選びました。Astramaelの分析によると、A..."
date: 2026-06-16T08:25:38+09:00
categories: ["テクノロジー"]
tags: ["Apple", "DCI-P3", "Adobe RGB", "色域", "ディスプレイ"]
image: "/rss/downloaded_images/d695ff70bb9e8728ef1a7617ecb745a8.jpg"
---

## AIによる要約
2015年10月に発売されたiMacでは、従来のsRGBより広い色域を持つDCI-P3系の色空間（Apple P3）を採用し、広く知られているAdobe RGBではなくこの新しい色空間を選びました。Astramaelの分析によると、Apple P3は青色を除く多くの色でバランスよく色域を広げており、黄緑・黄・オレンジ・赤・マゼンタなどではAdobe RGBよりも広い範囲をカバーできる一方、青緑や一部の緑ではAdobe RGBの方が優れていることがわかりました。これにより、一般ユーザーが日常的に撮影した写真や映像をより鮮やかに楽しめるようになることが期待されます。

この選択は、専門的な印刷や映像制作だけでなく、幅広い消費者が色の豊かさを実感できることを重視したものと考えられます。結果として、今後のスマートフォンやタブレットなどの消費者向けデバイスでも、特定の色に偏らないバランスの良い色域拡大が求められる傾向が強まる可能性があります。また、コンテンツ制作側も、こうしたディスプレイの特性を踏まえた色管理を意識する必要が出てくるでしょう。
