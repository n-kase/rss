---
title: "The good news bears: Inside the adorably unorthodox design of Bears Gratitude"
description: "概要と事実 この記事は、2025年2月4日に公開された「The good news bears: Inside the adorably unorthodox design of Bears Gratitude」というタイトルの記事を..."
date: 2026-06-16T11:10:57+09:00
categories: ["テクノロジー"]
tags: ["Bears Gratitude", "Apple Design Award", "ジャーナリングアプリ", "夫婦開発チーム", "非定型設計"]
image: "/rss/downloaded_images/02bb4576d4a574b1b777bcb349032539.jpeg"
---

## AIによる要約

### 概要と事実
この記事は、2025年2月4日に公開された「The good news bears: Inside the adorably unorthodox design of Bears Gratitude」というタイトルの記事を紹介しています。記事の中心は、オーストラリア出身の夫婦チーム、Isuru Wanasinghe（プログラマー）とNayomi Hettiarachchi（イラストレーター）が開発したジャーナリングアプリ「Bears Gratitude」が、Apple Design Awardの「Delight and Fun」部門で受賞したことです。このアプリは、手書き風のクマのキャラクターを使い、「Today isn’t over yet」や「Compliment someone」などのプロンプトカードを左右にスワイプして閲覧し、日々の小さな達成感や感謝の気持ちを記録することを促します。開発のきっかけは、Covid-19ロックダウン中にHettiarachchiが描きためたイラストでした。当初は「Bears Countdown」という誕生日や旅行などのカウントダウンアプリとしてリリースし、そこから感謝の習慣をサポートする「Bears Gratitude」へと発展させました。特筆すべきは、設計プロセスが非常に直線的で、ユーザーが実際に体験する順序と同じように画面を作ったこと、サインイン画面を設けずすぐにジャーナリングを開始できるようにしたこと、そしてプロンプトをユーザー自身の声で書くことで親しみやすさを演出した点です。受賞後のコメントでは、開発者は「アートがすべての中心」であり、このアプリを通じて人々の日常に意味のあるつながりを提供できたことに感謝しています。

### ネットの反応と意見の変遷
この記事にはネット上の反応やコメントは含まれていません。したがって、ネットの反応や意見の変遷については事実のみを記載します。

### 背景と結論
Bears Gratitudeの成功は、開発者が自分たちの強みであるイラストを軸にし、従来のアプリ設計の常識を意図的に外した点にあります。ユーザー体験を第一に考え、サインインや複雑なメニューを省くことで、すぐに感謝の習慣を始められるシンプルさを実現しました。また、クマのキャラクターというビジュアルアイコンが、ジャーナリングという地味な活動に親しみと楽しさを与え、日常の中での小さな幸せに気づくきっかけとなっています。この事例は、デザインにおいて「自分たちが本当に伝えたいもの」を中心に据え、技術的な制約よりも感情的なつながりを優先することが、ユーザーに受け入れられる製品を生み出す一例であると言えます。今後も同様に、クリエイターの個性やストーリーテリングがアプリの核となるケースが増えることが期待されます。

[🔗 元記事を読む](https://developer.apple.com/news/?id=i74v3f4r)
...
![A drawing from Bears Gratitude, showing two cartoon bears wearing party hats in front of a frosted birthday cake against a beige background.](/rss/downloaded_images/02bb4576d4a574b1b777bcb349032539.jpeg)
...
![A screenshot from Bears Gratitude that shows several prompt cards containing journaling prompts like “My Good Day,” “A Meal With Boo,” and “Finally On My Chores.”](/rss/downloaded_images/a675fe3240b9e58e712f716f65d7ac6a.jpeg)
...
[Download Bears Gratitude from the App Store](https://apps.apple.com/us/app/bears-gratitude/id6443609622)
...
![A photo of the Australian husband-and-wife team who developed Bears Gratitude, Isuru Wanasinghe and Nayomi Hettiarachchi, sitting at a table in front of a MacBook and iPad.](/rss/downloaded_images/f8c1511f33c23073a214cff16d8d2244.jpeg)
...
![A photo in which a gray and white cat stands on a table looking at drawings from Bears Gratitude. An iPad and candle sit on the table near the cat.](/rss/downloaded_images/50f71305f854514868ec342e3373f1da.jpeg)
...
![Early design sketches for Bears Gratitude, showing three cards with Bears Gratitude mascots on them, as well as placeholder copy.](/rss/downloaded_images/f0e69e4879e5e4f62be22bf8ac4491fa.jpeg)
