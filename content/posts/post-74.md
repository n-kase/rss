...
## AIによる要約
英語の単語の形がその意味を連想させると、脳はその単語をより速く正確に処理できるというカールトン大学の研究が示され、bedやloopなどの見た目が意味を表す単語が被験者から高い評価を得た。この視覚的図像性が語彙処理速度に影響することが複数のデータベースで確認され、言語理解において文字の形も重要な手がかりであることが改めて指摘された。したがって、言語学習やデザインにおいて単語の見た目を意味に合わせることで情報伝達の効率を上げられるという教訓が得られる。
