...
description: "Zyphraは2026年6月12日に、人物の声を高精度で再現し任意のテキストをリアルタイムで合成できる音声合成AI「ZONOS2」を発表した。このモデルは80億パラメーターのうち9億がアクティブなMoE構造で、前バージョンよりデータセ..."
date: 2026-06-16T08:21:59+09:00
categories: ["テクノロジー"]
tags: ["音声合成", "AI", "ZONOS2", "オープンソース", "ディープフェイク"]
image: "/rss/downloaded_images/148ed3f1b191fc889ad9c549656eb173.png"
---

## AIによる要約
Zyphraは2026年6月12日に、人物の声を高精度で再現し任意のテキストをリアルタイムで合成できる音声合成AI「ZONOS2」を発表した。このモデルは80億パラメーターのうち9億がアクティブなMoE構造で、前バージョンよりデータセットを200万時間以上に拡大し、日本語を含むティア1言語での性能を大幅に向上させている。オープンソースとしてApache 2.0ライセンスで公開され、AMDのクラウドサービスでも利用可能であり、トランプ大統領やオバマ元大統領の声を使ったエヴァンゲリオンやガンダムに関するデモ音声も公開された。こうした技術の進展は、エンターテイメントやアクセシビリティ分野での新たな表現手段を広げる一方で、偽音声による誤情報拡散やなりすましのリスクが高まっていることを示唆している。したがって、音声クローン技術の社会的影響を踏まえ、利用者はコンテンツの真偽を慎重に判断し、プラットフォーム側は検出ツールやガイドラインの整備を進めるべきであり、技術の恩恵を享受しつつ悪用を防ぐバランスが求められる。

[🔗 元記事を読む](https://gigazine.net/news/20260615-tts-zonos2-amd-zyphra/)
