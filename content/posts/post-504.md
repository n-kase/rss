...
description: "Apple Design Awardを受賞したThings, Inc.の「Rooms」は、ゲームでもツールでもなく、ブロックのように積み上げられるボクセルを使って自由に3D空間を作れるアプリであり、ユーザーが自分だけの部屋や世界を構築..."
date: 2026-06-15T18:58:40+09:00
categories: ["テクノロジー"]
tags: ["Rooms", "Apple Design Award", "voxel", "ソーシャルネットワーク", "クリエイティブアプリ"]
image: "/rss/downloaded_images/042b625f600be7cc9f986f4baa4f1042.jpeg"
---

## AIによる要約
Apple Design Awardを受賞したThings, Inc.の「Rooms」は、ゲームでもツールでもなく、ブロックのように積み上げられるボクセルを使って自由に3D空間を作れるアプリであり、ユーザーが自分だけの部屋や世界を構築し、アイテムのコードを見てカスタマイズできるソーシャルネットワークとしても機能している。このオープンな創作空間は、幼児から祖父母まで幅広い年齢層に受け入れられ、ウイルス的に広がる動画や口コミでモバイル利用が急増し、ユーザーは長時間かけて部屋を編集するようになった。その結果、コミュニティがアイテムを共有・改良し合うことでライブラリが1万点以上に拡大し、単なる遊びから本格的なプログラミングまで多様な使い方が生まれている。この事例から、敷居を低くしつつ可能性を高める設計が、創造性と学びを促し、幅広いユーザーに価値を提供できるという教訓が得られる。
...
![異なるスクリーンを表示する一連のiPhoneが、深い紫の背景に対して斜めに浮かんでいる様子。](/rss/downloaded_images/042b625f600be7cc9f986f4baa4f1042.jpeg)

ジェイソン・トフに彼のApple Design Award受賞作がゲームかアプリかを尋ねると、彼の答えは「はい」だ。

「『Rooms』には一文で説明できるようなものはなく、それがむしろ祝福だ」とトフは笑いながら言う。Things, Inc.のCEO兼チーフデザイナーである彼は続ける。「それは完全にゲームでもなければ、完全にツールでもない。むしろおもちゃに近い。」

さらに、それは白紙のキャンバスであり、居心地の良いゲームであり、コーディングの先生であり、ソーシャルネットワークでもある――だが、話が先走っている。本質的に、*Rooms*はユーザーが生成した3D空間の集まりで、初期インターネットの開かれた世界のような感覚を与える。空の部屋または既存のテンプレートから始め、ボクセルの装飾品、アイテム、ペット、アバターを好きなように配置して、大学のアパート、中世の城の部屋、浮遊するファンタジー世界、海賊船、ウィーザーのコンサート（本当に）など、好きな空間を作り出すことができる。唯一の制限は部屋の境界だが、*Rooms*のファンはそれをも乗り越えてきた。「私たちの404ページは壁のない部屋だ」とトフは言う。「だから人々はそれをコピーして制限を回避し始めた。」

ADA ファクトシート

![ボクセルアートスタイルで散らかった学生寮の部屋を示すRoomsのスクリーンショット。ロフトベッド、本棚、そしてさまざまな本と装飾品が見える。](/rss/downloaded_images/2912bbd9fa76859a05484fbd12752d9c.jpeg)

### Rooms

- **受賞部門:**ビジュアルとグラフィック
- **チーム:**Things, Inc.
- **対応プラットフォーム:**iOS, iPadOS
- **チーム規模:**4人

[App StoreからRoomsをダウンロード](https://apps.apple.com/us/app/rooms/id6443548715)

実際、このコミュニティ要素が強みとなっている。奇抜なゲーム、落ち着ける場所、巧みなアイディアが織りなすこの創造的なタペストリーは、実際の人々によって作り出されており、*Rooms*はソーシャルネットワークとしても機能している。さらに、ユーザーは各アイテムをクリックすると
